 ...
 * @author Abdullah
 */
public class WordsListGen implements Runnable {
    ...
    private void generate(int wl, String[] alpha) {

        try {


            int wordlength = wl; //10;
            String[] alphabet = alpha; //{ '0', '1','2' };
...
//                }
            ...
            Logger.getLogger(WordsListGen.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
